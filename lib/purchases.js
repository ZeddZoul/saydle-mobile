 ...
 * what lets the paywall keep working — completing on the free plan — months
 * before there is anything to actually buy.
 *
 ...
 * `{ available: false }` as having no key at all — the paywall shows no plans
 * and completes on the free plan instead of taking the app down.
 */
function usableKey() {
