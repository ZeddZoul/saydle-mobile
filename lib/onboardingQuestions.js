...
export const ONBOARDING_QUESTIONS = [
  ...
  },
  {
    key: "limitingBelief",
    kind: "text",
    // Consent belongs where the data is given, not only in a linked policy.
    // This is the first question that asks someone to type something about
    // themselves, and what they type goes to a third-party model.
    aiNote: true,
