...
export function videoShareAvailable() {
  // iOS only, for now, and deliberately: the Kotlin encoder compiles but has
  // never once executed on a device, and this flag is what keeps that untested
  // native path out of customers' hands. Verifying it on hardware and deleting
  // this line is the whole ticket. The still-image share is unaffected.
