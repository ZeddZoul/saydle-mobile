...
/**
 * The legal documents, served by the API itself (see server legal.routes.js).
 * Derived from API_URL so the links always point at the deployment the app is
 * actually talking to — a separate hardcoded domain would drift on day one.
 */
