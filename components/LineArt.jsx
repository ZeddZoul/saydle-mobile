...
const ART = {
  ...
  myWords: (s) => (
    <G>
      <Path
        d="M78 20c-6 14-20 32-34 44-6 5-10 9-12 14"
        stroke={s}
        strokeWidth="1.3"
        strokeLinecap="round"
        fill="none"
      />
      <Path
        d="M78 20c-14 2-24 10-28 20 8 4 20 0 28-20Z"
        stroke={s}
        strokeWidth="1.2"
        fill="none"
      />
      <Path
        d="M24 86c10-4 22-4 32 0"
        stroke={s}
        strokeWidth="1.1"
        strokeLinecap="round"
        opacity="0.65"
  ...
  subscription: (s) => (
    <G>
      ...
      <Path
        d="M32 42h50M44 22l13 64M70 22L57 86"
        stroke={s}
        strokeWidth="1.1"
        opacity="0.6"
        fill="none"
